# -*- coding: utf-8 -*-
"""chart_image_alexnet_share.ipynb
m22aie233
"""
...
# Read CSV files
train_df = pd.read_csv('/content/grive/MyDrive/Colab Notebooks/mlassignments/fractal3/charts/train.csv')
...
# Create datasets
train_dataset = ChartDataset(train_df, '/content/grive/MyDrive/Colab Notebooks/mlassignments/fractal3/charts/train', transform=transform)
val_dataset = ChartDataset(val_df, '/content/grive/MyDrive/Colab Notebooks/mlassignments/fractal3/charts/train', transform=transform)
